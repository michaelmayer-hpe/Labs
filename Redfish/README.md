...
![HttpRequester Setup](img/httprequester-icon.png)
...
![HttpRequester Open](img/httprequester-open.png)
...
![HttpRequester Request](img/httprequester-request.png)
...
![HttpRequester Answer](img/httprequester-answer.png)
...
![HttpRequester Reset](img/httprequester-power.png)
...
![HttpRequester History](img/httprequester-history.png)
...
![HttpRequester Open Data](img/httprequester-odata.png)
...
![HttpRequester BIOS](img/httprequester-bios.png)
...
![HttpRequester Action](img/httprequester-action.png)
...
![HttpRequester Content to Send](img/httprequester-contenttosend.png)

Hit the Submit button. You should get a successful answer: 

![HttpRequester Success](img/httprequester-successfulanswer.png)
...
![Launch iLO](img/ilo-launch.png)

You may need, again, to allow Firefox to load unsecure content:

![Firefox Insecure](img/firefox-insecure.png)
...
![Httpfox listen](img/httpfox-listen.png)
  4. Sent a query via httprequester.
![Httpfox post](img/httpfox-post.png)
  5. Stop httpfox.
